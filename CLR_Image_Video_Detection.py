...
#model_name = 'models/research/object_detection/inference_graph/saved_model'
#detection_model = load_model(model_name)
detection_model = tf.saved_model.load('models/research/object_detection/inference_graph/saved_model')
